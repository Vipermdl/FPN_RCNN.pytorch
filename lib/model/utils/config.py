...
__C.ANCHOR_SCALES = [8,16,32]#[1, 2, 4, 8, 16, 24, 32, 36, 40, 48]#

#'ANCHOR_SCALES', '[1, 2, 4, 8, 12, 16, 20, 24, 32, 36, 40, 44, 48]', 'ANCHOR_RATIOS', '[0.05, 0.1, 0.23, 0.33, 0.5, 0.6, 0.75, 0.8, 1, 2, 3, 4]', 'MAX_NUM_GT_BOXES', '10']

# Anchor ratios for RPN
__C.ANCHOR_RATIOS = [0.5,1,2]#[0.05, 0.1, 0.23, 0.33, 0.5, 0.6, 0.75, 0.8, 1, 2, 3, 4]#
